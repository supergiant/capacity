...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "ClusterCapacity Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("ClusterCapacityController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("ClusterCapacityController")
})
