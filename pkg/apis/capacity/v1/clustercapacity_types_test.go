...
import (
	...
	. "github.com/supergiant/capacity/pkg/client/clientset/versioned/typed/capacity/v1"
)

// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the ClusterCapacity resource tests

var _ = Describe("ClusterCapacity", func() {
	var instance ClusterCapacity
	var expected ClusterCapacity
	var client ClusterCapacityInterface

	BeforeEach(func() {
		instance = ClusterCapacity{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.CapacityV1().ClusterCapacities("default")
