...
import (
	...
	capacity "github.com/supergiant/capacity/pkg/client/informers/externalversions/capacity"
...
func (f *sharedInformerFactory) Capacity() capacity.Interface {
	return capacity.New(f, f.namespace, f.tweakListOptions)
}
